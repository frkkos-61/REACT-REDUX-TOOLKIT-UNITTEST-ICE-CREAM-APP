      ...
      <div className="flex gap-[23px]">
        <div className="bg-white p-[30px_25px_40px_30px] rounded-2xl text-black">
          <div className="flex gap-[20px]">
            ...
            <div>
              <h3 className="text-[24px] font-semibold">Çılgın Dondurmacı</h3>
          ...
          <p className="mt-[15px] lg:max-w-[300px]">Karşı konulmaz dondurma lezzetlerimizle donmuş mutluluğun tadını çıkarın!</p>
        </div>
